...
CREATE TABLE IF NOT EXISTS `ecoPlastic`.`notas_usuario` (
  `fk_idusers` INT NOT NULL,
  `nota` TEXT NOT NULL,
  INDEX `fk_notas_usuario_usuario1_idx` (`fk_idusers` ASC) ,
...
CREATE TABLE IF NOT EXISTS `ecoPlastic`.`ref_archivos_adjuntos` (
  ...
  INDEX `fk_ref_archivos_adjuntos_archivos_adjuntos1_idx` (`fk_idArchivo` ASC) ,
...
CREATE TABLE IF NOT EXISTS `ecoPlastic`.`rating` (
  ...
  INDEX `fk_rating_productos1_idx` (`productos_idproductos` ASC) ,
...
-- -----------------------------------------------------
-- Table `ecoPlastic`.`explorador_archivos_usuario`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `ecoPlastic`.`archivos_publicacion`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecoPlastic`.`archivos_publicacion` ;

CREATE TABLE IF NOT EXISTS `ecoPlastic`.`archivos_publicacion` (
  `fk_idPublicacion` INT NOT NULL,
  `fk_idArchivo` INT NOT NULL,
  INDEX `fk_archivos_publicacion_productos1_idx` (`fk_idPublicacion` ASC) ,
  INDEX `fk_archivos_publicacion_archivos_adjuntos1_idx` (`fk_idArchivo` ASC) ,
  CONSTRAINT `fk_archivos_publicacion_productos1`
    FOREIGN KEY (`fk_idPublicacion`)
    REFERENCES `ecoPlastic`.`productos` (`idproductos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_archivos_publicacion_archivos_adjuntos1`
    FOREIGN KEY (`fk_idArchivo`)
    REFERENCES `ecoPlastic`.`archivos_adjuntos` (`idArchivo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
