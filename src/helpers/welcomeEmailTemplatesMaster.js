export const welcomeEmailTemplatesMaster = (cedula, email, nombre) => {
                ...
                <tr>
                  ...
                  <td width="500" colspan="3" align="center">
                    <div class="contentEditableContainer contentTextEditable" >
                                  <div class="contentEditable" >
                                    <h2 style="margin-bottom: 15px;">${nombre} BIENVENID@ A LA FAMILIA ECOPLASTIC</h2>
                                  </div>
                              </div>
                  </td>
                  <td width="50">&nbsp;</td>
                ...
                <tr>
                  ...
                  <td width="500" align="left" style="padding-bottom:15px;">
                    <div class="contentEditableContainer contentTextEditable">
                                  <div class="contentEditable" >
                                      <p>
                                      Te damos la bienvenid@ a la familia EcoPlastic, para nosotros es un honor que nos ayudes en esta lucha contra el cambio climático,
                                      ...
                                      Puede iniciar sesion con su correo y contraseña registradas. <br /><br />
                  ...
                  <div class="contentEditableContainer contentTextEditable">
                    <div class="contentEditable" >
                      <span style="font-size:13px;color:#181818;font-family:Helvetica, Arial, sans-serif;line-height:200%; margin-left: 20px;">Enviado a ${email}</span>
                                        <br/>
                      <span style="font-size:11px;color:#555;font-family:Helvetica, Arial, sans-serif;line-height:200%; margin-left: 20px;">Carrera 19 # 25 - 23 Barranquilla, Colombia. | +57 3116534760</span>
                      <br/>
                      <span style="font-size:11px;color:#555;font-family:Helvetica, Arial, sans-serif;line-height:200%; margin-left: 20px;">Copyright © 2022 | EcoPlastic LTDA.</span>
                      <br/>
                    </div>
                  </div>
